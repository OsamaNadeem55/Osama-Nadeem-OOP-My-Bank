...
interface BankAccount {
  ...
  const customers: Customer[] = [
    new Customer("Osama", "Nadeem", "male", 22, 1234567890, accounts[0]),
    new Customer("Hussain", "Memon", "Male", 22, 9876543210, accounts[1]),
    new Customer("Haram", "Imran", "Female", 19, 5555555555, accounts[2]),
  ];
